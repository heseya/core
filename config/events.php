...
return [
    'permissions' => [
        ...
        EventType::PRODUCT_PRICE_UPDATED->value => ['products.show_details', 'products.show'],
        ...
        EventType::DISCOUNT_CREATED->value => ['discounts.show_details', 'discounts.show'],
        EventType::DISCOUNT_UPDATED->value => ['discounts.show_details', 'discounts.show'],
        EventType::DISCOUNT_DELETED->value => ['discounts.show_details', 'discounts.show'],
        EventType::LANGUAGE_CREATED->value => [],
        EventType::LANGUAGE_UPDATED->value => [],
        EventType::LANGUAGE_DELETED->value => [],
    ...
    'permissions_hidden' => [
        ...
        EventType::PRODUCT_PRICE_UPDATED->value => ['products.show_hidden'],
        ...
        EventType::LANGUAGE_CREATED->value => ['languages.show_hidden'],
        EventType::LANGUAGE_UPDATED->value => ['languages.show_hidden'],
        EventType::LANGUAGE_DELETED->value => ['languages.show_hidden'],
    ],
];

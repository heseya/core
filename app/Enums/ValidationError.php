...
enum ValidationError: string
{
    ...
    case CONSENTSEXISTS = 'VALIDATION_CONSENT_EXISTS';
    ...
    case EMAILUNIQUE = 'VALIDATION_EMAIL_TAKEN';
    case ORGANIZATIONUNIQUEVAT = 'VALIDATION_ORGANIZATION_VAT';
    case MYORGANIZATIONUNIQUEVAT = 'VALIDATION_MY_ORGANIZATION_VAT';
    case ORGANIZATIONSAVEDADDRESSDEFAULT = 'VALIDATION_ORGANIZATION_ADDRESS_DEFAULT';
    case SALESCHANNELDEFAULT = 'VALIDATION_SALES_CHANNEL_DEFAULT';
    case SALESCHANNELACTIVITYORGANIZATION = 'VALIDATION_SALES_CHANNEL_ACTIVITY_ORGANIZATION';
    case ORDERORGANIZATIONREQUIRED = 'VALIDATION_ORDER_ORGANIZATION_REQUIRED';
    case ORDERSALESCHANNELREQUIRED = 'VALIDATION_ORDER_SALES_CHANNEL_REQUIRED';

    ...
    public function index(Request $request): array
    {
        return [
            'attributes' => ($request->filled('attribute_slug') || $this->resource->relationLoaded('productAttributes'))
                ...
                : [],
            'relevancy' => [
                'title_position' => is_infinite($this->resource->title_position) || is_nan($this->resource->title_position) ? 0 : $this->resource->title_position, // @phpstan-ignore-line,
                'title_relevancy' => is_infinite($this->resource->title_relevancy) || is_nan($this->resource->title_relevancy) ? 0 : $this->resource->title_relevancy, // @phpstan-ignore-line
                'title_natural_relevancy' => is_infinite($this->resource->title_natural_relevancy) || is_nan($this->resource->title_natural_relevancy) ? 0 : $this->resource->title_natural_relevancy, // @phpstan-ignore-line
                'title_words_relevancy' => is_infinite($this->resource->title_words_relevancy) || is_nan($this->resource->title_words_relevancy) ? 0 : $this->resource->title_words_relevancy, // @phpstan-ignore-line

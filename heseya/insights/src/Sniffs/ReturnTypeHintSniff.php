...
use SlevomatCodingStandard\Sniffs\TypeHints\ReturnTypeHintSniff as ReturnTypeHint;

class ReturnTypeHintSniff extends ReturnTypeHint
{
    /**
     ...
     * @param array<ReturnAnnotation> $prefixedReturnAnnotations
     */
    ...
    private function hasTraversableTypeHint(
        ...
        return $this->hasReturnAnnotation($returnAnnotation)
            && AnnotationTypeHelper::containsTraversableType(

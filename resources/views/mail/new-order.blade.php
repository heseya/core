    ...
    <style type="text/css">
      ...
      ><p style="line-height: 30px; margin: 10px 0; text-align: center; color:#151e23; font-size:30p; font-family:Georgia,Helvetica,Arial,sans-serif">Potwierdzenie złożenia zamówienia nr {{ $order->code }}</p></div>
      ...
      ><p> Drogi kliencie,<br /> Dziękujemy za złożenie zamówienia. Status zamówienia możesz śledzić na naszej stronie internetowej. Gdy zmieni się status otrzymasz również osobnego maila.<br /><br /> Poniżej znajdują się szczegóły Twojego zamówienia: </p></div>
      ...
      >
        <tr style="border-bottom:1px solid #ecedee;text-align:left;padding:15px 0;">
            ...
            <th style="padding: 0 15px;">Ilość</th>
            <th style="padding: 0 0 0 15px;">Suma</th>
          </tr>
          ...
          <tr>
            ...
            <td style="padding: 0 0 0 15px;">{{ $item->price }} {{ $order->currency }}</td>
          </tr>
          @endforeach
      </table>
      ...
      ><p>
            Wartość zamówienia: <b>{{ $order->summary - $order->shipping_price }} {{ $order->currency }}</b><br />
            Koszt dostawy: <b>{{ $order->shipping_price }} {{ $order->currency }}</b><br />
          </p>
          <p style="font-size: 20px">Razem: <b>{{ $order->summary }} {{ $order->currency }}</b><br /></p></div>

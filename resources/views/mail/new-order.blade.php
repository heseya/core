                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        style="font-family:Arial, sans-serif;font-size:26px;font-weight:bold;line-height:28px;text-align:center;text-transform:uppercase;color:#000000;">@lang('mail.thanks', ['name' => $settingsService->getSetting('store_name')->value])</div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:30px;text-align:center;">
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding:10px 25px;padding-top:10px;padding-bottom:0;word-break:break-word;">
                                    <div
                                        ...
                                        <mj-column>
                                            <p style="text-align: center; background-color: #244d8b; color: #fff; font-size:14px"
                                               text-transform="uppercase">@lang('mail.info'):</p>
                                            <p style="text-align: center;"> @lang('mail.number-date', ['number' => $order->code, 'date' => $order->created_at->format('d-m-Y')]) </p> @if ($order->shippingMethod)
                                                <p style="text-align: center;"> @lang('mail.delivery')
                                                    : {{ $order->shippingMethod->name }} </p>
                                            @endif
                                        </mj-column>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div
                                        style="font-family:Arial, sans-serif;font-size:16px;line-height:22px;text-align:left;color:#333333;">
                                        <p style="text-align: center; background-color: #244d8b; color: #fff; font-size:14px"
                                           text-transform="uppercase">@lang('mail.products'):</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                        ...
                                        <tr>
                                            ...
                                            <td><b>{{ $order->shipping_price->getAmount() }} {{ $order->currency }}</b>
                                            </td>
                                        </tr> @if ($order->cart_total_initial !== $order->cart_total)
                                            <tr>
                                                <td style="width: 180px">@lang('mail.summary-discount'):</td>
                                                <td>
                                                    <b>{{ $order->cart_total_initial->minus($order->cart_total)->getAmount() }} {{ $order->currency }}</b>
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div
                                        style="font-family:Arial, sans-serif;font-size:14px;line-height:22px;text-align:left;color:#000000;">
                                        <p style="text-align: center; background-color: #244d8b; color: #fff; font-size:14px"
                                           text-transform="uppercase">@lang('mail.purchaser'):</p>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div
                                        style="font-family:Arial, sans-serif;font-size:10px;line-height:14px;text-align:right;color:#000000;">
                            ...
                            <tr>
                                <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div
                                        ...
                                        <p> @lang('mail.regards'),
                                            <br/> @lang('mail.team', ['team' => $settingsService->getSetting('store_name')->value])
                                        </p>
                                    </div>
                                </td>
                            </tr>

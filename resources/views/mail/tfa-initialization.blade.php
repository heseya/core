                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        style="font-family:Arial, sans-serif;font-size:32px;line-height:22px;text-align:center;text-transform:uppercase;color:#55575d;">{{ $settingsService->getSetting('store_name')->value }}</div>
                                </td>
                            </tr>
                            </tbody>
                        </table>

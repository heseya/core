                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                           style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">@foreach ($products as $product)
                                            <tr style="border-bottom: 2px #244d8b solid;">
                                                <td style="padding: 15px 15px 15px 0;"
                                                    colspan="2">{{ $product->name }}</td>

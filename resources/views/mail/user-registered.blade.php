                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <div
                                        style="font-family:DM Serif Display;font-size:32px;line-height:34px;text-align:center;text-transform:uppercase;color:#000000;">
                                        <b> @lang('mail.register-thanks', ['name' => $settingsService->getSetting('store_name')->value]) </b>
                                    </div>
                                </td>
                            </tr>
                            </tbody>

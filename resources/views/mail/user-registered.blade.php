                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:20px;word-break:break-word;">
                                    <div style="font-family:DM Serif Display;font-size:32px;line-height:34px;text-align:center;text-transform:uppercase;color:#000000;"><b> @lang('mail.register-thanks', ['name' => $settingsService->getSetting('store_name')->value]) </b></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>

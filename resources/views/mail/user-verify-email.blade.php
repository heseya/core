...
<div style="background-color:#FFFFFF;">
    ...
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tbody>
            <tr>
                <td style="direction:ltr;font-size:0px;padding:0 0;padding-bottom:0;text-align:center;">
                    <!--[if mso | IE]>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div
                                        ...
                                        <p>@lang('mail.verify-email-hello'),</p>
                                        <p>
                                            @lang('mail.verify-email-message')
                                            <a href="{{ $url }}" target="_blank">@lang('mail.verify-email-link')</a>
                                        </p>
                                        <p>@lang('mail.verify-email-warning')</p>
                                    </div>
                                </td>
                            </tr>
                            </tbody>

    ...
    <table style="border-collapse: collapse; margin: 0; padding: 0; width: 100% !important; font-family: 'Jura', sans-serif; max-width: 420px" cellspacing="0" cellpadding="0" border="0" align="center"><tbody>
      ...
      <tr>
        <td>
          <tr>
            <td align="center">
              <a href="https://kupdepth.pl" target="_blank">
                <img src="https://kupdepth.pl/img/loga/depth-b.svg" alt="DEPTH" style="border:none" height="64">
              </a>
            </td>
          </tr>
          <tr>
      ...
      <tr>
        <td align="center">
          <a href="mailto:shop@kupdepth.pl" style="color: #017173; text-decoration: none; font-weight: bold; font-size: 14px; padding: 0 20px;" target="_blank">
            shop@kupdepth.pl
          </a>
        </td>
      </tr>

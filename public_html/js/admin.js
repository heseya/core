...
__webpack_require__(/*! ./admin/nav.js */ "./resources/js/admin/nav.js");
...
/*#__PURE__*/
function () {
  function Panel(content, position) {
  ...
  _createClass(Panel, [{
    ...
    value: function slide(position) {
      ...
      this.handler = setTimeout(function () {
        return _this.dom.classList.remove('slide');
      }.bind(this), slideTime);
    }
  }, {
    key: "warp",
    value: function warp(position) {
  ...
  _createClass(Interface, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(config) {
        ...
        var init, panels, tabs, l, p, response, content, panel, _loop, t;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                if (!(p < panels[l].length)) {
                  _context.next = 22;
                  break;
                }

                _context.next = 12;
                return fetch(panels[l][p].src);
              ...
              case 25:
                ...
                _loop = function _loop(t) {
                  ...
                  tab.onclick = function () {
                    _this2.switchPanel(tabs[t].panel);
                  };

                  _this2.tabs.appendChild(tab);
                };
    ...
    value: function switchPanel(panel) {
      ...
      for (var id in this.panels) {
        if (panel == id || this.focus == id) this.panels[id].slide(this.panels[panel].position);else this.panels[id].warp(this.panels[panel].position);
      }
    ...
    key: "slide",
    value: function slide(target) {
      if (this.handlers[target]) clearTimeout(this.handlers[target]);
      target.classList.add('slide');
      this.handlers[target] = setTimeout(function () {
        return target.classList.remove('slide');
      }, slideTime);
    }
  }]);
...
window.updateOrders = function () {
  ...
  fetch('/api/admin/orders', {
    ...
    data.forEach(function (row) {
      ...
      e.onclick = function () {
        return window["interface"].switchPanel('order');
      };

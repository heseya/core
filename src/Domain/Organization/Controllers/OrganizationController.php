...
final class OrganizationController extends Controller
{
    ...
    public function show(Request $request, Organization $organization): JsonResource
    {
    ...
    public function update(string $id, OrganizationUpdateDto $dto): JsonResource
    {
        return OrganizationResource::make($this->organizationService->update($id, $dto));
    }

...
final class PriceRepository
{
     ...
     */
    public function setModelPrices(DiscountCondition|ModelIdentityDto|Option|Product $model, array $priceMatrix): void
    {
        $rows = [];
    ...
    /**
     * @param array<integer,ProductPriceType|OptionPriceType|DiscountConditionPriceType|string> $priceTypes
     *
     * @return Collection<int, Price>
     */
    public function getModelPrices(DiscountCondition|ModelIdentityDto|Option|Product $model, array $priceTypes, ?Currency $currency = null): Collection
    {
        ...
        $query = Price::query()
            ...
            ->whereIn('price_type', Arr::map($priceTypes, fn (DiscountConditionPriceType|OptionPriceType|ProductPriceType|string $item) => is_string($item) ? $item : $item->value));
